...
function RecoverInformation() {
    ...
    const mensaje = `send?phone=${telefono}&text=*ENVIADO DESDE LA WEB*%0A%0A*Tipo de servicio:*%0ASuper%0A%0A${encodeURIComponent(productInfo)}*Super seleccionado:*%0A${typeSuper}${anotherNewSuper}%0A%0A*Dirección de entrega:*%0A${direction}%0A%0A*Whats'App:*%0A${whatsapp}%0A%0A*Forma de pago:*%0A${payDelivery}%0A%0A*Tipo de pedido:*%0A${typedelivery}${additionalInfo}`;
