...
function RecoverInformation() {
    ...
    const mensaje = `send?phone=${telefono}&text=*ENVIADO DESDE LA WEB*%0A%0A*Tipo de servicio:*%0AEncomiendas%0A%0A${encodeURIComponent(productInfo)}%0A%0A*Nombre Completo:*%0A${nameComplete}%0A%0A*Dirección de entrega:*%0A${direction}%0A%0A*Whats'App:*%0A${whatsapp}%0A%0A*Forma de pago:*%0A${payDelivery}%0A%0A*Tipo de pedido:*%0A${typedelivery}${additionalInfo}`;
